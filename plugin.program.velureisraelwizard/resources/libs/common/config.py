...
class Config:
    ...
    def init_paths(self):
        ...
        self.CUSTOM_ART = os.path.join(self.PLUGIN, 'resources', 'velure_israel_art')
    ...
    def init_settings(self):
        ...
        # VELURE-ISRAEL - Auto force addon updates on Kodi startup
